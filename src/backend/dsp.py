...
class RadioDSP:
    ...
    def _build_channel_filters(self):
        ...
        # NBFM: relaxed narrowband filter for real-world public safety channels.
        # Historically 12.5kHz channels map to ~6.25kHz half-band, but in practice
        # slight tuning error / wider deviation often sounds better with ~8-10kHz.
        self._nbfm_taps = firwin(129, 8500, fs=ir).astype(np.float32)
